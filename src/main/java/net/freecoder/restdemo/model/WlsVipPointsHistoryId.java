...
/**
 * WlsVipPointsHistoryId generated by hbm2java
 */
public class WlsVipPointsHistoryId implements java.io.Serializable {

	private String id;
	private String wlsVipId;

	public WlsVipPointsHistoryId() {
	}

	public WlsVipPointsHistoryId(String id, String wlsVipId) {
		this.id = id;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof WlsVipPointsHistoryId))
			return false;
		WlsVipPointsHistoryId castOther = (WlsVipPointsHistoryId) other;
