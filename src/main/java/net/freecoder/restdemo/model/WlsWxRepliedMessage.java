...
/**
 * WlsWxRepliedMessage generated by hbm2java
 */
public class WlsWxRepliedMessage implements java.io.Serializable {
	...
	private String wlsWxReceivedMessageId;
	private String wlsWxAccountId;

	public WlsWxRepliedMessage() {
	}

	public WlsWxRepliedMessage(String id, String wlsWxAccountId) {
		this.id = id;
		this.wlsWxAccountId = wlsWxAccountId;
	}

	public WlsWxRepliedMessage(String id, String toUsername,
			...
			Date appCreateTime, String wlsWxReceivedMessageId,
		...
		this.wlsWxReceivedMessageId = wlsWxReceivedMessageId;
		this.wlsWxAccountId = wlsWxAccountId;
	}
	...
	public String getWlsWxReceivedMessageId() {
		return this.wlsWxReceivedMessageId;
	}

	public void setWlsWxReceivedMessageId(String wlsWxReceivedMessageId) {
		this.wlsWxReceivedMessageId = wlsWxReceivedMessageId;
	}
